	...
	<div class="row">
		<div class="col-md-9">
			<div class="panel shadow">
				<div class="header">
					<h2 class="title"><i class="fas fa-info-circle"></i> @lang('Details Posts')</h2>
					<a class="btn btn-danger btn-back" href="{!! route('Posts') !!}"><i class="fas fa-undo-alt"></i> @lang('Back to Posts')</i></a>
				</div>
